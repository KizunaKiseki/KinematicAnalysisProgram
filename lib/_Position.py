...
def p4_figures(figure_path: list, figure_names: list, O2: np.ndarray, O4: np.ndarray, 
               array_P1: np.ndarray, array_P2: np.ndarray, array_P4: np.ndarray, crank_angle_plot: np.ndarray) -> tuple[list, list]:
    """
...
def p6_figures(figure_path: list, figure_names: list, O2: np.ndarray, O4: np.ndarray, 
               array_P1: np.ndarray, array_P2: np.ndarray, array_P4: np.ndarray, array_P5: np.ndarray, 
